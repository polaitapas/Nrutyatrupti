...
const categories: {
...
}[] = [
  {
    ...
    images: pick([
      '/images/nrutyatrupti-class-studio-practice.jpg',
      '/images/nrutyatrupti-class-studio-session.jpg',
      '/images/nrutyatrupti-summer-class-circle-formation.jpg',
      '/images/IMG_20240816_185134.jpg',
      '/images/nrutyatrupti-summer-class-community-meal.jpg',
  ...
  },
  {
    ...
    images: pick([
      ...
      '/images/nrutyatrupti-summer-class-performance.jpg',
      '/images/nrutyatrupti-summer-class-stage.jpg',
